...
(function (global) {
  ...
  // 20.3.2.1 Date ( year, month [, date [ , hours [ , minutes [ , seconds [ ,
	// ms ] ] ] ] ] )
  // 20.3.2.2 Date ( value )
  // 20.3.2.3 Date ( )
  ...
  // 20.3.3.4 Date.UTC ( year, month [ , date [ , hours [ , minutes [ ,
	// seconds [ , ms ] ] ] ] ] )
  ...
  // 21.1.3.10 String.prototype.localeCompare ( that [, reserved1 [ ,
	// reserved2 ] ] )
  ...
  ['Int8Array', 'Uint8Array', 'Uint8ClampedArray',
   ...
   'Float32Array', 'Float64Array'].forEach(function ($TypedArrayName$) {
     ...
     // 22.2.3.16 %TypedArray%.prototype.lastIndexOf ( searchElement [ ,
		// fromIndex ] )
     ...
     // 22.2.3.20 %TypedArray%.prototype.reduceRight ( callbackfn [,
		// initialValue] )
     ...
     // 22.2.3.27 %TypedArray%.prototype.toLocaleString ([ reserved1 [ ,
		// reserved2 ] ])
  ...
  (function() {
	...
	// )
    // 24.1.1.5 GetValueFromBuffer ( arrayBuffer, byteIndex, type,
	// isLittleEndian )
  ...
  (function() {
    ...
    // 24.2.4.13 DataView.prototype.setFloat32 ( byteOffset, value [ ,
	// littleEndian ] )
    // 24.2.4.14 DataView.prototype.setFloat64 ( byteOffset, value [ ,
	// littleEndian ] )
    // 24.2.4.15 DataView.prototype.setInt8 ( byteOffset, value )
    // 24.2.4.16 DataView.prototype.setInt16 ( byteOffset, value [ ,
	// littleEndian ] )
    // 24.2.4.17 DataView.prototype.setInt32 ( byteOffset, value [ ,
	// littleEndian ] )
    // 24.2.4.18 DataView.prototype.setUint8 ( byteOffset, value )
    // 24.2.4.19 DataView.prototype.setUint16 ( byteOffset, value [ ,
	// littleEndian ] )
    // 24.2.4.20 DataView.prototype.setUint32 ( byteOffset, value [ ,
	// littleEndian ] )
      ...
      for (var i = 0; i < this.attributes.length; ++i) {
        ...
        if (attr.specified && attr.name.substring(0, 5) === 'data-') {
          (function(element, name) {
            ...
            result[prop] = element.getAttribute('data-' + name); // Read-only,
																	// for IE8-
...
(function(global) {
  ...
  // Use addEvent(object, event, handler) instead of
  ...
  // Needed for: IE9-
  // Use getClassList(elem) instead of elem.classList() if IE7- support is
	// needed
  ...
  mixin(global.Document || global.HTMLDocument, ParentNode); // HTMLDocument
																// for IE8
    ...
    function URL(url, base) {
      ...
      if (base) {
        url = (function () {
          ...
          try {
            var doc;
            // Use another document/base tag/anchor for relative URL resolution,
			// if possible
      ...
      // (an Object.defineProperties polyfill that doesn't support
		// getters/setters may throw)
